...
#' @return \code{posDF}with updated positions.
...
#' @param distribution string with distribution name, among:
#' 'normal', 'uniform', 'poisson', 'bernoulli', 'binomial',
#' 'geometric', 'degenerate', 'chisq', 'weibull'.
#' @param param1 Numeric with first parameter from the distribution.
#' @param param2 Numeric with second parameter from the distribution.
#' @return Numeric of length 1 with distance generated from the specified distribution.
#' @importFrom stats rnorm runif rpois rbinom rgeom rchisq rweibull
